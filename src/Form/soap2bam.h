...
int  print_Ausage_Formt01()
{
	cout <<""
		...
		"\t\t-Q  <int>   change the sequence quality score by [+31] or [-31] or [0], default [0]\n"
		"\t\t-g          search for the mate information when PE reads did not store adjacently\n"
		"\n"
