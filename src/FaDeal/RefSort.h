...
int  usage_sort()
{
	cout <<""
		...
		"\n"
		"\t\t-i     <str>   input FASTA\n"
		"\t\t-o     <str>   output sorted FASTA, default [STDOUT]\n"
		"\n"
		"\t\t-s     <str>   how to sort FASTA ([name] or [length]), default [name]\n"
...
void More_HelpFA_10 ()
{
	cout<<"\n\
\n\
\t\t1.  sort -i <in.fa> -o AAA \n\
\t\tthis will sort the input FASTA by name in ascending way and output the result to a compressed file named AAA in current directory.\n\
\n\
\t\t2.  sort -i <in.fa> -o AAA -s length\n\
\t\tthis will sort the input FASTA by length in ascending way and output the result to a compressed file named AAA in current directory.\n\
\n\
\t\t3.  sort -i <in.fa> -o AAA -d\n\
