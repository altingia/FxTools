...
int  print_AusageFQ_reverse()
{
	cout <<""
		...
		"\t\t-s    <str>   set all the bases to [upper] or [lower] case\n"
...
void More_HelpFQ12()
{
	cout<<"\n\
\n\
\t\t1.  reform -i <in.fq> -o AAA -r -c\n\
\t\tthis will create the reverse complement of the input FASTQ and output to a compressed file named AAA in current directory.\n\
\n\
\n";
}
...
{
	if (argc <=1 ) {print_AusageFQ_reverse();return 0;}
