...
int  print_usage_rand()
{
	cout <<""
		"\n"
		"Usage:rand  -i <1.fq> <2.fq> -o <out.1.fq> <out.2.fq>\n"
		"\n"
...
void More_HelpFQ7()
{
	cout<<"\n\
\n\
\t\t1.  rand -i <1.fq> <2.fq> -p X -o <out.1> <out.2>\n\
\t\trand -i <1.fq> -p X -o <out.1> \n\
...
{
	if (argc <=1) {print_usage_rand();return 0;}
