...
int  print_File01()
{
	cout <<""
		"\n"
		"\tUsage: SF -i <file1>  <file2>  -s <int> -ID1 <int> -ID2 <int>\n"
		"\n"
		"\t\t-i    <str>    input two files for set operation\n"
		//		"\t\t-b    <str>    Input File2 for same or diff\n"
		"\t\t\n"
		"\t\t-ID1  <int>    specifications of the columns in file1 used for operation  row 1,2 [2]\n"
		"\t\t-ID2  <int>    specifications of the columns in file2 used for operation  row 1,2 [2]\n"
		"\t\t-o    <str>    output file, default [STDOUT]\n"
		"\t\t-s    <int>    1: same in file1; 2: diff in file1;\n"
		"\t\t               3: same in file2; 4: diff in file2;\n"
...
\t\t\t  Set1:              Set2:\n\
\t\t\t1 2 3 4 5          1 3 5 7 9\n\
\t\t\t6 7 8 9 10         6 7 8 4 3\n\
\t\t\t1 2 3 4 5          9 8 7 6 5\n\
\n\
\t\t1.  SF -i set1 set2 -ID 1,3 -ID 1,3 -s 1\n\
...
\n\
\t\t2.  SF -i set1 set2 -ID 1 -ID 1 -s 4\n\
...
\t\tThis will find the rows in set1 and set2 on which set1 and set2 are the same in the second column. As the example above, this will give the second rows of both sets: \n\
\t\t6 7 8 9 10\n\
\t\t6 7 8 4 3\n\
\n\
\n";
...
{
	if (argc <=1 ) {print_File01();return 0;}
